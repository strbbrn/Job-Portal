...
<script src="js/bootstrap.min.js" type="54f5afb730902141e7b1cbc9-text/javascript"></script>
...
if(isset($_SESSION['username'])&& !empty($_SESSION['username'])){
    ...
    echo "<li><a href='applied-job.php'>View Applied Jobs</a></li>";
}else
{
...
<div class="nav-right">
<a href="employer/index.php" class="btn">Post Your Job</a>
</div>
